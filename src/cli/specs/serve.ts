...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orca serve [--port <port>] [--pairing-address <host>] [--mobile-pairing | --wear-pairing] [--no-pairing] [--project-root <path>] [--recipe-json] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'port',
      'pairing-address',
    ...
    notes: [
      ...
      'Use --wear-pairing to print a watch-scoped pairing link instead of the default runtime-environment pairing link.',
    ...
    examples: [
      ...
      'orca serve --pairing-address 100.64.1.20 --wear-pairing'
    ]
  }
]
